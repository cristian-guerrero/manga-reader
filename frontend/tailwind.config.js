    ...
    extend: {
      ...
      colors: {
        ...
        accent: {
          ...
          hover: 'var(--color-accent-hover, #7c3aed)',
        },
        surface: {
          primary: 'var(--color-surface-primary, #0f0f23)',
          secondary: 'var(--color-surface-secondary, #1a1a2e)',
          tertiary: 'var(--color-surface-tertiary, #16213e)',
          elevated: 'var(--color-surface-elevated, #1f2937)',
        },
        titlebar: {
          bg: 'var(--color-titlebar-bg, #0f0f23)',
          text: 'var(--color-titlebar-text, #e5e7eb)',
        },
      },
      fontFamily: {
