...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className = '', variant = 'primary', size = 'md', isLoading, icon, rightIcon, children, disabled, ...props }, ref) => {
        ...
        const variants = {
            ...
            outline: 'bg-transparent text-text-primary border border-border hover:bg-surface-tertiary active:scale-[0.98]',
