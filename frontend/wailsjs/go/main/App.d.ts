...
export function ColorizeImage(arg1:string,arg2:boolean,arg3:boolean,arg4:boolean,arg5:number,arg6:number):Promise<colorizer.ColorizeResponse>;

export function ColorizerGetServerURL():Promise<string>;

export function ColorizerGetStatus():Promise<colorizer.InstallProgress>;

export function ColorizerHealthCheck():Promise<boolean>;

export function ColorizerInstall():Promise<void>;

export function ColorizerIsInstalled():Promise<boolean>;
...
export function GetUpdateState():Promise<updater.UpdateState>;
...
export function IsUpdatePending():Promise<boolean>;
